...
class MapView extends StatelessWidget {
                ...
                child: Container(
                  ...
                  child: PageView.builder(
                      ...
                      onPageChanged: (currentPageInd) async {
                        var currentObj = _dashboardController.arrStoreList[currentPageInd];
                      ...
                      itemBuilder: (context, ind) {
                        ...
                        return InkWell(
                          onTap: () {
                            Get.toNamed("/storeDetailsView", arguments: _dashboardController.arrStoreList[ind].id.toString());
                          },
                          child: storeDetailContainer(_dashboardController.arrStoreList[ind]),
                        );
                      }),
                ),
              ),
  ...
  void zoomForPerticuarIndex(StoreList currentObj) async {
    ...
    controller.animateCamera(CameraUpdate.newLatLngZoom(LatLng(double.parse(currentObj.latitude), double.parse(currentObj.longitude)), 18));
  }
  ...
  AppBar appbar() {
    return AppBar(
      ...
      title: Text(
        'mapView'.tr,
        style: TextStyle(fontFamily: AppFont.bold, fontSize: 15, color: Colors.black),
      ),
      centerTitle: true,
    );
  }
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // totalFeedBack
                totalFeedback(avgRating: currentObj.avgRating, totalReview: currentObj.totalFeedback.toString()),
              ],
            ),
          ),
        ],
  ...
  SizedBox storeName(String name) {
    return SizedBox(
      ...
      child: Text(
        ...
        softWrap: true,
        style: TextStyle(color: Colors.black, fontFamily: AppFont.bold, fontSize: 17.0),
      ),
    );
  }
...
// Rating bar
  ...
  Row totalFeedback({String totalReview, String avgRating}) {
    return Row(
      children: [
        Text(
          avgRating,
          style: TextStyle(color: Color(0xFFe09c9c), fontFamily: AppFont.medium, fontSize: 12),
        ),
        SizedBox(
          width: 5,
        ),
        Text(
          ...
          style: TextStyle(color: Color(0xFFa3a6ab), fontFamily: AppFont.medium, fontSize: 12),
        ),
      ],
    );
  }
