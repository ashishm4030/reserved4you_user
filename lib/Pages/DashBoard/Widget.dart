...
class HomeUnits {
  Widget categoryShell({String imgurl, String categoryName, bool isSelected}) {
    return Container(
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(color: isSelected ? Color(0xFFdb8a8a).withOpacity(0.2) : Color(AppColor.logoBgColor), spreadRadius: 1, blurRadius: 10, offset: Offset(0, 20))
                  ],
                ),
