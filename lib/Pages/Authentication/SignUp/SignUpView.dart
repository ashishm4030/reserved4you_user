...
import 'package:reserve_for_you_user/Pages/Authentication/Login/LoginController.dart';
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              ...
              style: TextStyle(color: Color(0xffa3a7ac), fontSize: 15, fontFamily: AppFont.regular),
            ),
          ),
          SizedBox(
            height: 30,
            ...
            Expanded(
              child: Container(
                ...
                child: Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('text1'.tr, maxLines: 8, style: TextStyle(color: Colors.black.withOpacity(0.8), fontSize: 15, fontFamily: AppFont.medium)),
                    InkWell(
                      child: Text('privacy'.tr, maxLines: 8, style: TextStyle(color: Colors.pink.withOpacity(0.8), fontSize: 15, fontFamily: AppFont.medium)),
                    ),
                  ],
                ),
              ),
  ...
  Widget bottomButtons() {
    return Column(
      children: [
        ...
        Center(
          child: Image.asset(
            'password'.tr == "Password" ? AssestPath.login + "or.png" : AssestPath.login + "oder.png",
            fit: BoxFit.cover,
