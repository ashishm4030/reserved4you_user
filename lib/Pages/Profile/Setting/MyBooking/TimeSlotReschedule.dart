...
class TimeSlotReschedule extends StatelessWidget {
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          child: SingleChildScrollView(
              ...
              child: InkWell(
                onTap: () {
                  controller.isOpenStylist.value = false;
                },
                child: Column(
                        ...
                        Column(
                          children: [
                            ...
                            Obx(
                              () => Padding(
                                padding: const EdgeInsets.fromLTRB(20, 20, 20, 0),
                                child: controller.isLoader.value ? shimmerBotttomTimeSloyGrid() : botttomTimeSloyGrid(),
                              ),
                            ),
                            SizedBox(
                              height: 100,
                            ...
                            () => Column(
                              children: [
                                ...
                                Padding(
                                    ...
                                    child: Visibility(
                                      visible: controller.isOpenStylist.value,
  ...
  Widget vanueName() {
    var currentObj = controller.currentPendingModel;
    return Container(
      width: Get.width,
      height: 100,
            ...
            Container(
              ...
              child: ClipRRect(
                ...
                child: CachedNetworkImage(
                  imageUrl: currentObj.serviceImage,
                  fit: BoxFit.cover,
                ),
              ),
...
//======== Select Stylist ==========
  ...
  Widget selectStylist(BuildContext context) {
    return InkWell(
      onTap: () {
        controller.isOpenStylist.value = !controller.isOpenStylist.value;
        controller.fabIconNumber.value = !controller.fabIconNumber.value;
      },
      child: Padding(
        padding: const EdgeInsets.fromLTRB(20, 20, 20, 0),
        child: Column(
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          child: Container(
                            decoration: BoxDecoration(),
                            child: controller.slectedStylistImage.value == '' ||
                                    controller.slectedStylistImage.value == null ||
                                    controller.slectedStylistImage.value == 'null' ||
                                    controller.slectedStylistImage.value == 'https://www.reserved4you.de/storage/app/public/default/default-user.png'
                                ? Container(
                                    ...
                                    child: Center(
                                      child: Builder(builder: (context) {
                                        List<String> nameList = controller.selectedStylistName.value.split(' ');
                                        String name = '';
                                ...
                                : CachedNetworkImage(
                                    imageUrl: controller.slectedStylistImage.toString(),
                        ...
                        Text(
                          controller.selectedStylistName.value,
                          style: TextStyle(fontSize: 15, fontFamily: AppFont.regular, color: Colors.black45),
                        ),
                        const Spacer(),
                        InkWell(
  ...
  Widget btnDone() {
    return InkWell(
      onTap: () {
        if (controller.timeSloteSelectedInd.value == "") {
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                 Obx(
                    () => Visibility(
                      visible: controller.isPrevious.value,
                      child: Container(
                        height: 30,
                        width: 30,
                        decoration: BoxDecoration(
                        ...
                        child: InkWell(
                          onTap: () {
                            controller.incrementDecrementDate(false);
                          },
                          child: Container(
                            child: Image.asset(
                  ...
                  Obx(
                    () => Text(
                      controller.currentDateFormated.value,
                      style: TextStyle(fontSize: 15, fontFamily: AppFont.medium),
                    ),
                  ),
                  InkWell(
                    onTap: () {
                      controller.incrementDecrementDate(true);
                    },
                    child: Container(
                      height: 30,
                      width: 30,
  ...
  Widget showAvailblrStylist() {
    return Container(
      ...
      child: ListView.builder(
          itemCount: controller.arrAvailbleEmplloyee.length,
          shrinkWrap: true,
          physics: NeverScrollableScrollPhysics(),
          itemBuilder: (context, ind) {
            var currentObj = controller.arrAvailbleEmplloyee[ind];
            ...
            return InkWell(
              onTap: () {
                controller.selectedStylistName.value = currentObj.empName;
                controller.slectedStylistImage.value = currentObj.empImagePath;
                controller.isOpenStylist.value = !controller.isOpenStylist.value;
                controller.getAvailbleTimeForStoreWithEmp(empid: currentObj.id.toString());
              },
              child: Column(
                children: [
                  Container(
  ...
  Widget botttomTimeSloyGrid() {
    return Obx(
      () => controller.arrAvailbleTimeSlote.length == 0
          ? Container(
              child: Center(
                child: Text(
                  'thisDayHoliday'.tr,
          ...
          : GridView.builder(
              ...
              itemCount: controller.arrAvailbleTimeSlote.length,
              itemBuilder: (context, ind) {
                var currentObj = controller.arrAvailbleTimeSlote[ind];

                if (currentObj.flag == "Booked") {
                  return InkWell(
                    onTap: () {
                    },
                    child: Obx(() => disableCelenderView(controller.arrAvailbleTimeSlote[ind])),
                  );
                } else {
                  return InkWell(
                    onTap: () {
                      controller.timeSloteSelectedInd.value = ind.toString();
                    },
                    child: Obx(() => celenderView(controller.arrAvailbleTimeSlote[ind], ind)),
                  );
                }
              }),
    );
...
//======== Celender ==========
  ...
  Widget celenderView(AvailableTimeSlot obj, int ind) {
    return Container(
      decoration: BoxDecoration(
          color: controller.timeSloteSelectedInd.value == ind.toString() ? Colors.black : Colors.white,
          borderRadius: BorderRadius.circular(10),
      ...
      child: Center(
        ...
        style: TextStyle(
          fontFamily: AppFont.medium,
          color: controller.timeSloteSelectedInd.value == ind.toString() ? Colors.white : Colors.black,
        ),
      )),
    );
  }
